...
class DashboardReporter:
    ...
    def report(
        ...
        *,
        ...
        buy_attempt: Optional[dict] = None,
        ...
        pnl_polling_mode: Optional[str] = None,
        pnl_legacy_triggers: Optional[bool] = None,
        pnl_focus_side: Optional[str] = None,
        pnl_focus_reason: Optional[str] = None,
        pnl_focus_directions: Optional[str] = None,
        pnl_trigger_mode: Optional[str] = None,
        ...
        payload: Dict[str, Any] = {
            ...
            "pnl_legacy_triggers": pnl_legacy_triggers,
            "pnl_focus_side": pnl_focus_side,
            "pnl_focus_reason": pnl_focus_reason,
            "pnl_focus_directions": pnl_focus_directions,
            "pnl_trigger_mode": pnl_trigger_mode,
