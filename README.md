...
| `PNL_POLLING_MODE` | No | bidirectional | Net P&L side to poll: `bidirectional` alternates, while `buy` or `sell` polls only that side and disables the opposite-side trigger |
